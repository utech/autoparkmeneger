...
#include <QtDebug>
//--------------------utech--------------------utech--------------------utech--------------------
UForm_AParkEditSumTabelWidget::UForm_AParkEditSumTabelWidget(int tWType, QWidget *parent, QDate dt)
...
//--------------------utech--------------------utech--------------------utech--------------------
UForm_AParkEditSumTabelWidget::~UForm_AParkEditSumTabelWidget()
{
	emit mainWindowClosed();
}
//--------------------utech--------------------utech--------------------utech--------------------
void UForm_AParkEditSumTabelWidget::populateToolBar(QToolBar * tBar)
{
	
}
//--------------------utech--------------------utech--------------------utech--------------------
void UForm_AParkEditSumTabelWidget::populateSumTabel()
{
...
//--------------------utech--------------------utech--------------------utech--------------------
void UForm_AParkEditSumTabelWidget::sumTabelCurRowChanged( const QModelIndex & curIndex, const QModelIndex & prevIndex)
{
	QAbstractItemModel * model = ui.tableWidget_tabel_sum->model();
	emit currentWorkerChanged(model->data(model->index(curIndex.row(),1)).toInt());
}
//--------------------utech--------------------utech--------------------utech--------------------
void UForm_AParkEditSumTabelWidget::updateSumTabelSQLRows(int row, int column)
{
	disconnect(ui.tableWidget_tabel_sum, SIGNAL(cellChanged (int,int)), this, SLOT(updateSumTabelSQLRows(int, int)));
...
//--------------------utech--------------------utech--------------------utech--------------------
void UForm_AParkEditSumTabelWidget::showOnlyWorkWorkersChanged(int state)
{
	if (state == Qt::Checked)
