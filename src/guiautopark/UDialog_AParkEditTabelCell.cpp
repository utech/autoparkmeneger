...
//--------------------utech--------------------utech--------------------utech--------------------
UDialog_AParkEditTabelCell::UDialog_AParkEditTabelCell(int nprId, QDate dt, QTableWidgetItem *item, QWidget *parent)
        : QDialog(parent), _dt(dt), _nprId(nprId), _item(item)
{
	...
	UTabelDay tabelDay = item->data(Qt::EditRole).value<UTabelDay>();
...
//--------------------utech--------------------utech--------------------utech--------------------
void UDialog_AParkEditTabelCell::pushButton_accept_clicked()
{
	QSqlQuery query;
...
//--------------------utech--------------------utech--------------------utech--------------------
void UDialog_AParkEditTabelCell::checkRobTime()
{
...
//--------------------utech--------------------utech--------------------utech--------------------
UDialog_AParkEditTabelCell::~UDialog_AParkEditTabelCell()
{
