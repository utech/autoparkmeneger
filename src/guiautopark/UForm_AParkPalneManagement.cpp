...
{
	UDialog_AParkPartnerMarkaPalnogoTwoDateFilter *d = new UDialog_AParkPartnerMarkaPalnogoTwoDateFilter(QDate::currentDate(), QDate::currentDate(), "Вибір реквізитів для реєстру", "dd.MM.yyyy", this);
	if (d->exec()) {
	    UPrintDocs_APark *printDocs = new UPrintDocs_APark();
